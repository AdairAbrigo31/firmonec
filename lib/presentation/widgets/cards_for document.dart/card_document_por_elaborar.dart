...
class CardDocumentPorElaborar extends ConsumerStatefulWidget {
  ...
  const CardDocumentPorElaborar({super.key, required this.doc, required this.rol});
...
class _CardDocumentPorElaborarState extends ConsumerState<CardDocumentPorElaborar> {
              ...
              children: [
                ...
                Column(
                  children: [
                    ...
                    Text(
                      'Categoria: ${widget.doc.categoria}',
                      textAlign: TextAlign.start,
                      style: AppTypography.bodyMedium,
                    ),
